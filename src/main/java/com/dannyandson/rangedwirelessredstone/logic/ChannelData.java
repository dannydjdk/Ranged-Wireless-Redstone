...
public class ChannelData {
    ...
    public void setTransmitterWeakSignal(BlockPos pos, int signal) {
        setTransmitterWeakSignal(getStringFromPos(pos),signal);
    }
     /**
    ...
    public void setTransmitterWeakSignal(BlockPos pos, int cellIndex, int signal) {
        setTransmitterWeakSignal(getStringFromPos(pos) + ", " + cellIndex,signal);
    }
    ...
    public void setTransmitterStrongSignal(BlockPos pos, int signal) {
        setTransmitterStrongSignal(getStringFromPos(pos),signal);
    }
    /**
     * Set the strong (direct) redstone value to be transmitted by a transmitter
     *
     * @param pos    position of the transmitter
     * @param cellIndex Cell index of tiny redstone component
     * @param signal The signal strength to be transmitted
     */
    public void setTransmitterStrongSignal(BlockPos pos, int cellIndex, int signal) {
        setTransmitterStrongSignal(getStringFromPos(pos) + ", " + cellIndex,signal);
    }
    ...
    private void removeTransmitter(String pos) {
        ...
        saveData.weakSignalMap.remove(pos);
        saveData.setDirty();
    }
    ...
    private static class ChannelSaveData extends WorldSavedData {
        ...
        public void load(CompoundNBT nbt) {
            ...
            CompoundNBT weakSignalData = nbt.getCompound("weaksignaldata");
        ...
        public CompoundNBT save(CompoundNBT nbt) {
            CompoundNBT channelData = new CompoundNBT(),
                    strongSignalData = new CompoundNBT(),
                    weakSignalData = new CompoundNBT();
